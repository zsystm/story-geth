...
var (
	...
	HarvestGenesisHash = common.HexToHash("0x4399c18e1bb1ed9a4ade914b61ec92606ba794a233bd4880759ac0e3b1f28e48")
)
...
var (
	...
	IliadChainConfig = &ChainConfig{
		...
		NostoiBlock:                   big.NewInt(1069000),
	}
	...
	HarvestChainConfig = &ChainConfig{
		ChainID:                       big.NewInt(2513),
		HomesteadBlock:                big.NewInt(0),
		EIP150Block:                   big.NewInt(0),
		EIP155Block:                   big.NewInt(0),
		EIP158Block:                   big.NewInt(0),
...
var NetworkNames = map[string]string{
	...
	HarvestChainConfig.ChainID.String(): "harvest",
}
